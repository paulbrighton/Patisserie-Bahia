<div class="c-post__author u-margin-bottom-20">
  <h2 class="u-screen-reader-text"><?php esc_html_e('About The Author', '_themename'); ?></h2>
  <?php
  ...
  <div class="c-post-author__content">
    <div class="c-post-author__title">
      <?php if ($author_website) { ?>
        <a target="blank" href="<?php echo esc_url($author_website) ?>">
        <?php }  ?>
