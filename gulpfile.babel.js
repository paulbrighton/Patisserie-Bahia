...
const paths = {
  styles: {
    src: ['src/assets/scss/main.scss', 'src/assets/scss/admin.scss', 'src/assets/scss/editor.scss'],
  ...
  scripts: {
    src: ['src/assets/js/main.js', 'src/assets/js/admin.js', 'src/assets/js/customize-preview.js'],
    dest: 'dist/assets/js'
  },
  plugins: {
...
// export const deleteReplacedFilenames = () => {
//   return del(
