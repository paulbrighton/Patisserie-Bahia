...
?>
  <<?php echo $tag ?> id="comment-<?php comment_ID(); ?>" <?php comment_class(['c-comment', $comment->comment_parent ? 'c-comment__child' : '']); ?>>
    <article id="div-comment-<?php comment_ID(); ?>" class="c-comment_body">
